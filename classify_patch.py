...
weights0.append(tf.Variable(tf.truncated_normal(
    [patch_size, patch_size, n_chan, depth_conv[0]], stddev=0.1)))
...
weights0.append(tf.Variable(tf.truncated_normal(
    [img_size // stride_conv[0]**2 * img_size // stride_conv[0]**2 * depth, 
     n_hidden], stddev=0.1)))
